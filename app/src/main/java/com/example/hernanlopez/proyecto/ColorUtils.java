...
public class ColorUtils {
	 ...
	 * @return
	 */
	public String getColorNameFromHex(String colorStr) {

		int re = Integer.valueOf( colorStr.substring(1, 3), 16);
		int ge = Integer.valueOf( colorStr.substring( 3, 5 ), 16 );
		int be = Integer.valueOf( colorStr.substring( 5, 7 ), 16);
		return getColorNameFromRgb(re, ge, be);
	}
