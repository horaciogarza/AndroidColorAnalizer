...
public class HistoryRealmRealmProxy extends com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm
    ...
    private void injectObjectContext() {
        ...
        this.proxyState = new ProxyState(com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm.class, this);
    ...
    @SuppressWarnings("cast")
    public static com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm obj = realm.createObjectInternal(com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm.class, true, excludeFields);
    ...
    public static com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm obj = new com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm();
        reader.beginObject();
    ...
    public static com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm copyOrUpdate(Realm realm, com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm) cachedRealmObject;
        } else {
            return copy(realm, object, update, cache);
        }
    }

    public static com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm copy(Realm realm, com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm realmObject = realm.createObjectInternal(com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm.class, false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm.class);
        long tableNativePtr = table.getNativeTablePointer();
        HistoryRealmColumnInfo columnInfo = (HistoryRealmColumnInfo) realm.schema.getColumnInfo(com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm.class);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativeTablePointer();
        HistoryRealmColumnInfo columnInfo = (HistoryRealmColumnInfo) realm.schema.getColumnInfo(com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm.class);
        com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm object = null;
        while (objects.hasNext()) {
            object = (com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm.class);
    ...
    public static com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm createDetachedCopy(com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm)cachedObject.object;
            } else {
                unmanagedObject = (com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.hgarzstudios.ColorAnalyzer.proyecto.HistoryRealm();
